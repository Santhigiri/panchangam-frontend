...
export default function StarfinderResultPanel({
  ...
  return (
    <Card className="rounded-xl bg-foreground py-5 text-background ring-foreground/20">
      <CardContent className="flex flex-col gap-4 px-5">
        <div className="flex flex-col items-center gap-0.5 text-center">
          ...
          <p className="font-inter text-sm font-medium text-background/70">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="flex flex-col items-center gap-1 rounded-lg bg-background/10 px-3 py-4 text-center">
            <Star className="h-5 w-5 text-primary" />
            <p className="font-inter text-[11px] font-semibold tracking-wide text-background/60">NAKSHATRA</p>
            <p className="font-playfair-display text-lg font-semibold">{nakshatra.en}</p>
          </div>
          <div className="flex flex-col items-center gap-1 rounded-lg bg-background/10 px-3 py-4 text-center">
            <MoonIcon className="h-5 w-5 text-primary" />
            <p className="font-inter text-[11px] font-semibold tracking-wide text-background/60">THITHI</p>
            <p className="font-playfair-display text-lg font-semibold">{thithi.en}</p>
            <p className="font-inter text-xs text-background/60">{thithi.paksha.en}</p>
          </div>
        </div>

        <div className="flex flex-col gap-2 rounded-lg bg-background/10 px-3 py-3">
          ...
          <Progress value={(daylightMinutes / 1440) * 100} className="h-1.5 bg-background/20" />
          <p className="text-center font-inter text-xs text-background/60">
